            ...
            return new List<Client>
                    {
                        new Client
                        {
                            ...
                            Claims=new List<ClientClaim>(){ 
                                new ClientClaim(){ Type="type1",Value="value1" },
                                new ClientClaim(){ Type="type2",Value="value2" },
                                new ClientClaim(){ Type="type3",Value="value3" },
                                new ClientClaim(){ Type="type4",Value="value4" }
                            }
                        }
                    };
        }
